...
fun RegisterComponent(
    ...
    onSignUpButtonClick: (fullName: String, username: String, password: String) -> Unit,
    ...
    var fullNameText by rememberSaveable {
        mutableStateOf("")
    }
    ...
    Column(
        ...
        Box(contentAlignment = Alignment.Center, modifier = Modifier.fillMaxWidth()) {
            Button(
                ...
                onClick = {
                    if (fullNameText.isEmpty() || usernameText.isEmpty() || passwordText.isEmpty()) {
                        Toast.makeText(context, "Mohon isi terlebih dahulu", Toast.LENGTH_SHORT).show()
                        return@Button
                    }
                    onSignUpButtonClick(fullNameText, usernameText, passwordText)
                }
            ) {
                Text(text = "Sign Up")
            }
